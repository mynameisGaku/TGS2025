...
enum TUI_COLLISION
{
	TUI_COLLISION_NONE,		// 当たり判定なし
	TUI_COLLISION_CIRCLE,	// 円の当たり判定
	TUI_COLLISION_RECT,		// 四角形の当たり判定
};
...
typedef struct
{
	...
	TUI_COLLISION			COLLISION		{};	// このUIの当たり判定方法
...
private:
	...
	TUI_COLLISION					m_Collision				{};	// このUIの当たり判定方法。デフォルトはなし。クリックイベントを発火させるために必要。
