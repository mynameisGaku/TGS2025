...
SceneBase::SceneBase(bool setCurrentScene) : SceneBase(setCurrentScene, "") {}

SceneBase::SceneBase(bool setCurrentScene, std::string name)
{
	if (setCurrentScene)
	...
	sceneName = name;
	sceneState = SceneState::BeforePlay;
}
