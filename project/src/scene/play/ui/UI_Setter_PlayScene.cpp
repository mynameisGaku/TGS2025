...
UI_Setter_PlayScene::UI_Setter_PlayScene()
{
	...
	for (int i = 0; i < CAMERA_NUM; i++)
	{
		...
		UI_HitPoint_Icon* hitPointIcon = new UI_HitPoint_Icon(RectTransform(Anchor::Preset::LeftDown, Vector2(0.0f, UI_CHATBAR_REF.PositionY - 30.0f), 0.0f, Vector2::Ones * 2.0f), i);
