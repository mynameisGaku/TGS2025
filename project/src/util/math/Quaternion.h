...
public:
	...
	*/
	...
	/**
		@brief		指定した方向を向くための回転を計算します。
		@param[in]	forward	: オブジェクトが向くべき前方方向ベクトル。
		@param[in]	up		: オブジェクトの上方向を示すベクトル（デフォルトはY軸方向）。
		@return		指定された方向を向くためのクォータニオン
		@details	forwardとupベクトルを使用して、オブジェクトが指定された方向を向くための回転を計算します。
	*/
