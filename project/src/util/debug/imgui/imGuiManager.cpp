...
namespace {
	...
	static const ImVec2 DEBUG_WINDOW_SIZE = ImVec2(270, static_cast<int>(WindowSetting::Inst().height));	// デバッグウィンドウの大きさ
	...
	static const ImVec2 INFO_WINDOW_POS = ImVec2(static_cast<int>(WindowSetting::Inst().width) - 200, 0);	// インフォメーションウィンドウの座標
