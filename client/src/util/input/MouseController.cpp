...
void MouseController::Update() {
	...
	int iScreenWidthHalf = static_cast<int>(WindowSetting::Inst().width) / 2;	// 画面の横幅の半分(int型)
	int iScreenHeightHalf = static_cast<int>(WindowSetting::Inst().height) / 2;	// 画面の縦幅の半分(int型)
